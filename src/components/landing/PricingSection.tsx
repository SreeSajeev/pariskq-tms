...
export function PricingSection() {
  ...
  return (
    <section className="bg-muted py-20 md:py-28" id="pricing">
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          {/* Toggle */}
          <div className="mt-6 inline-flex items-center gap-3 rounded-full bg-border p-1">
            <button
            ...
            >
              Annual <span className="text-success text-xs font-semibold">Save 2 months</span>
            </button>
          </div>
        </motion.div>
          ...
          {plans.map((plan, i) => {
            ...
            return (
              ...
              >
                {plan.popular && (
                  <span
                    className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full px-4 py-1 text-xs font-semibold text-white uppercase tracking-wider"
