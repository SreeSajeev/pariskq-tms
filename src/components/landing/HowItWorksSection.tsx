    ...
    <section className="bg-background py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="relative grid gap-8 md:grid-cols-4">
          ...
          <div className="absolute left-0 right-0 top-8 hidden h-px bg-neutral-200 md:block" />
          ...
          {steps.map((step, i) => (
            ...
            >
              <div className="relative mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full border-2 border-primary-500 bg-card shadow-sm">
                <span className="absolute -top-2 -right-2 flex h-6 w-6 items-center justify-center rounded-full bg-primary-500 text-xs font-bold text-primary-foreground">
                  {i + 1}
                </span>
                <step.icon className="h-6 w-6 text-primary-800" />
              </div>
